...
plt.title('Voz Andrea Separada (PCA)')
plt.xlabel('Tiempo (s)')
plt.ylabel('Amplitud')
plt.grid(True)
...
plt.subplot(3, 2, 2)
plt.semilogx(freqs[:N//2], X_voz1[:N//2], label='Espectro Voz Andrea (PCA)', color='orange')
plt.title('Espectro de Voz Andrea (Escala Semilogarítmica) - PCA')
...
plt.title('Voz Laura Separada (PCA)')
plt.xlabel('Tiempo (s)')
plt.ylabel('Amplitud')
plt.grid(True)
...
plt.subplot(3, 2, 4)
plt.semilogx(freqs[:N//2], X_voz2[:N//2], label='Espectro Voz Laura (PCA)', color='pink')
plt.title('Espectro de Voz Laura (Escala Semilogarítmica) - PCA')
plt.xlabel('Frecuencia (Hz)')
plt.ylabel('Magnitud')
plt.grid(True)
